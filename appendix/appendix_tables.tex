...
\begin{table}[H]
\setlength{\tabcolsep}{4pt} % default is 6pt, lower to 3pt or 2pt
\small
\centering
...
\begin{table}[H]
  ...
  \caption{\small{
    ...
    a derived price factor (column ``Price Factor'') calculated using these CPI values to express nominal amounts in 2023 euros.  
