...
\bottomrule
\end{tabular}
\caption{\small{Estimates corresponding to Table \ref{tab:logit_probit_lpm_results_200}, using the same model specifications but classifying students as eligible if their theoretical entitlement exceeds 200 EUR.}}
