...
\begin{abstract}
\setstretch{1}
This paper examines the non-take-up of Germany’s federal student aid program (BAföG) using microsimulation techniques based on data from the German Socio-Economic Panel (SOEP) for the years 2007–2021. 
