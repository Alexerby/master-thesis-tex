...
% TODO: this section also ends quite abruptly
% TODO: Move this section (5.1.1 identifying NTU and beta error) or even merge it with section 5.1.3 "Eligibility misclassification and beta errors". Would flow more naturally to go from the 5.1 subchapter about the microsimulation to 5.1.2 the simulation pipeline, then it is also in kind of chronological order, from us assembling all the background data to us analysing the result of that in terms of the eligibility misclassification, beta errors etc.
% TODO: MERGE 5.1.2 AND 5.1.3
