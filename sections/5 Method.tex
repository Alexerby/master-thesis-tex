...
% Method
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Overview of Analytical Strategy}
...
\subsubsection{Data Sources and Legal Basis}
% Maybe ref all our data sources, the statutory and soep
\subsubsection{Simulation Pipeline}
% Explain simulation pipeline and reference appendix tables for reader to get more information
\subsubsection{Validation Strategy} % No idea what this means
