\section{Method (DISREGARD THIS SECTION - TO BE CHANGED TO PROBIT MODEL)} 
...
% Define three groups 
% \begin{itemize}
%   \item Eligible + Takes BAföG
%   \item Eligible + Does not take BAföG
%   \item Not Eligible + Takes BAföG (missclassifications/errors)
% \end{itemize}

% Model the probability of student taking up the loan using a logistic regression 
% \begin{equation}
%   \text{Pr}(\text{Takeup}_{i} = 1 \mid X_{i} )
% \end{equation}
...
% R is the Bedarfssatz, rename this
