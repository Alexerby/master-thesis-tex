...
The OECD groups countries into three broad types when it comes to student support systems. The first includes the Nordic countries, where students don’t pay tuition fees and receive generous financial aid. The second type is characterised by high tuition fees and substantial student aid and includes countries such as the United Kingdom, Australia, New Zealand, the United States and Lithuania \citep{oecd_education_2024}.

Germany falls into the third category, where tuition fees are low to moderate and financial support is more limited. In these countries, less than half of tertiary students receive public aid. Other countries in this group include Austria, France, Spain, Italy, and Romania \citep{oecd_education_2024}.
...
Some sources claim that since the introduction of BAföG in 1971, the proportion of students receiving financial aid has fallen from around 50\% to around 15\% as of 2023. Thereof, around 50\% received full funding \citep{meier_bafog_2024}.
